---
name: continue
description: Resume development on an existing PR — restore context and continue from where it left off. Use when given a PR number or URL to continue working on.
---
