---
name: plan
description: Analyze a new requirement, create an implementation plan, and publish it as a GitHub issue. Use when starting new work or when a user describes a feature/task to plan.
---
