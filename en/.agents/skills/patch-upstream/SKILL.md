---
name: patch-upstream
description: Generate a patch file and translate PR body to English for upstream contribution. Requires an existing PR on origin.
---
...
**Prerequisite: A PR must already exist on origin (created via `pr`).**
...
- **PR doesn't exist:** Instruct "Create a PR first with `pr`." and **stop**.
